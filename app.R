...
ui <- fluidPage(
  ...
  tags$div(class = "title",
           titlePanel(tags$h1("EDUC-Y 502: Lecture notes B.1 - Tabular & graphical summary representations of frequencies"))),
  
  # Sidebar panel                                                               # <----- will need to be figured out
  
  sidebarLayout(position = "left",
                sidebarPanel("links to other lecture notes"),
                mainPanel()
  ),
  
  tags$h2("Welcome"),
  
  tags$h5("In this class we will look at ", em("statistics"), " in an ", strong("applied"), " sense."),
